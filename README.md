...
2. Load an included demo or example dataset where available.
3. Run the default analysis and review outputs.
4. Export results and compare with validation artifacts referenced in the manuscript.

## Reproducibility
- Manuscript: F1000_Software_Tool_Article.md
- Real-review checklist: F1000_Submission_Checklist_RealReview.md
