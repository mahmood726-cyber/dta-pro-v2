        # Dta Pro V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/dta-pro-v2.git

        ## Objective

        DTA Pro v2 is a 54K-line browser-based diagnostic test accuracy meta-analysis platform implementing bivariate models, HSROC, forest plots, and SROC curve visualisation.
        ...
        - Code: https://github.com/mahmood726-cyber/dta-pro-v2.git
